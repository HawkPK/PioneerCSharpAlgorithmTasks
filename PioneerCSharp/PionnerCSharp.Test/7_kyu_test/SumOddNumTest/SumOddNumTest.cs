    ...
    public class SumOddNumTest
    {
        ...
        public void ShouldThirdIndexReturn3Basis()
        {
           Assert.AreEqual(8, Kata.rowSumOddNumberBasis(2));
            Assert.AreEqual(27, Kata.rowSumOddNumberBasis(3));
            Assert.AreEqual(64, Kata.rowSumOddNumberBasis(4));
            Assert.AreEqual(125, Kata.rowSumOddNumberBasis(5));
            Assert.AreEqual(74088, Kata.rowSumOddNumberBasis(42));
        }
    }
}
